...
public data class EditTodoFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): EditTodoFragmentArgs {
      bundle.setClassLoader(EditTodoFragmentArgs::class.java.classLoader)
      val __taskId : Int
      ...
      return EditTodoFragmentArgs(__taskId)
    }
  }
}

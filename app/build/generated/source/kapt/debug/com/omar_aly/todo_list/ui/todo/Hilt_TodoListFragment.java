...
public abstract class Hilt_TodoListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TodoListFragment() {
    super();
  }

  Hilt_TodoListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TodoListFragment_GeneratedInjector) this.generatedComponent()).injectTodoListFragment(UnsafeCasts.<TodoListFragment>unsafeCast(this));
    }
  }

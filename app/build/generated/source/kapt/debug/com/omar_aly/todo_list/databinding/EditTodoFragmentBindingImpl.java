...
public class EditTodoFragmentBindingImpl extends EditTodoFragmentBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.task_name_input, 5);
        sViewsWithIds.put(R.id.task_description_input, 6);
        sViewsWithIds.put(R.id.time_p, 7);
        sViewsWithIds.put(R.id.tag_list, 8);
    ...
    private EditTodoFragmentBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            ...
            , (com.omar_aly.todo_list.ui.custom.TimePickerCustom) bindings[7]

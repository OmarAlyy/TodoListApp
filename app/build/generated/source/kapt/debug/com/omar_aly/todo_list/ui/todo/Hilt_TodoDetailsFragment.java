...
public abstract class Hilt_TodoDetailsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TodoDetailsFragment() {
    super();
  }

  Hilt_TodoDetailsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TodoDetailsFragment_GeneratedInjector) this.generatedComponent()).injectTodoDetailsFragment(UnsafeCasts.<TodoDetailsFragment>unsafeCast(this));
    }
  }

...
public abstract class Hilt_EditTodoFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EditTodoFragment() {
    super();
  }

  Hilt_EditTodoFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EditTodoFragment_GeneratedInjector) this.generatedComponent()).injectEditTodoFragment(UnsafeCasts.<EditTodoFragment>unsafeCast(this));
    }
  }

...
public abstract class Hilt_AddTodoFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddTodoFragment() {
    super();
  }

  Hilt_AddTodoFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddTodoFragment_GeneratedInjector) this.generatedComponent()).injectAddTodoFragment(UnsafeCasts.<AddTodoFragment>unsafeCast(this));
    }
  }
